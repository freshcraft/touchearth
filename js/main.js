(function($) {
    ...
    $('.slider').slick({
        ...
        // prevArrow: '<button type="button" class="slick-prev"> <img src="images/arrow-left-white1.png" alt="arrow"></button>',
        // nextArrow: '<button type="button" class="slick-next"> <img src="images/arrow-right-white1.png" alt="arrow"></button>',
    }).slickAnimation();
